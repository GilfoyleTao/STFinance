...
import { DaysCollectModel } from '../../../Component/Calendar/CalendarModel';
...
export class HomeSignPage {
  ...
  constructor(public elementRef: ElementRef, public renderer: Renderer) {
      ...
      this.ok=true;
      this.L_ExchangeList=[
        { 'id': 1, 'text': '连续7天签到可替换', 'img': 'assets/img/gift1.png' },
        { 'id': 2, 'text': '连续30天签到可替换', 'img': 'assets/img/gift2.png' }
      ]
  }
  ngAfterViewInit() {
